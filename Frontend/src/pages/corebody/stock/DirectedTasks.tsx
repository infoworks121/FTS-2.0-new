...
import { getCoreBodyNavGroups } from "@/config/coreBodySidebarConfig";
import { 
  Truck, 
  AlertCircle, 
  CheckCircle2, 
...
export default function DirectedTasks() {
  const groups = getCoreBodyNavGroups("A");
  ...
  return (
    <DashboardLayout role="corebody" navItems={navItems as any} roleLabel="Hub Specialist">
