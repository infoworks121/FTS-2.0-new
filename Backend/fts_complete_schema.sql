...
CREATE TABLE fulfillment_assignments (
    ...
    source_district_id  INT REFERENCES districts(id) ON DELETE RESTRICT,
    items               JSONB,
    status              VARCHAR(30) DEFAULT 'assigned',
    is_shortage_fulfillment BOOLEAN DEFAULT FALSE,
    assigned_at         TIMESTAMPTZ DEFAULT NOW(),
...
-- =============================================================================
-- PAYMENT GATEWAY CONFIGURATIONS (SUPER ADMIN ONLY)
-- =============================================================================
